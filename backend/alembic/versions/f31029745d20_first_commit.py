...
Revision ID: f31029745d20
Revises: 
Create Date: 2021-04-04 10:02:11.864406
...
def upgrade():
    ...
    op.create_table('access_grants_dataset',
    ...
    op.create_table('query_requests_access',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('query_id', 'access_id')
    )
    op.create_index(op.f('ix_query_requests_access_id'), 'query_requests_access', ['id'], unique=False)
    op.create_table('query_uses_dataset',
    sa.Column('query_id', sa.Integer(), nullable=False),
    sa.Column('dataset_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['dataset_id'], ['dataset.id'], ),
    sa.ForeignKeyConstraint(['query_id'], ['query.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('query_uses_dataset')
    op.drop_index(op.f('ix_query_requests_access_id'), table_name='query_requests_access')
    op.drop_table('query_requests_access')
    ...
    op.drop_table('file')
    op.drop_table('access_grants_dataset')
